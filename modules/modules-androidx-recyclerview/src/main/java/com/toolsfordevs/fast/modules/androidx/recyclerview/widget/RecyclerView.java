...
import com.toolsfordevs.fast.modules.androidx.annotation.IntDef;
import com.toolsfordevs.fast.modules.androidx.annotation.Px;
import com.toolsfordevs.fast.modules.androidx.core.util.Preconditions;
import com.toolsfordevs.fast.modules.androidx.core.view.*;
import com.toolsfordevs.fast.modules.androidx.core.view.accessibility.AccessibilityEventCompat;
import com.toolsfordevs.fast.modules.androidx.core.view.accessibility.AccessibilityNodeInfoCompat;
import com.toolsfordevs.fast.modules.androidx.core.widget.EdgeEffectCompat;
import com.toolsfordevs.fast.modules.androidx.customview.view.AbsSavedState;
import com.toolsfordevs.fast.modules.androidx.recyclerview.widget.RecyclerView.ItemAnimator.ItemHolderInfo;
...
import static com.toolsfordevs.fast.modules.androidx.core.view.ViewCompat.TYPE_NON_TOUCH;
import static com.toolsfordevs.fast.modules.androidx.core.view.ViewCompat.TYPE_TOUCH;
...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    void smoothScrollBy(@Px int dx, @Px int dy,  Interpolator interpolator,
    ...
    public static class EdgeEffectFactory {
         ...
         */
        protected  EdgeEffect createEdgeEffect( RecyclerView view,
    ...
    public abstract static class LayoutManager {
         ...
         */
        public void getTransformedBoundingBox( View child, boolean includeDecorInsets,
                                               Rect out) {
         ...
         * @param itemCount
         */
        public void onItemsMoved( RecyclerView recyclerView, int from, int to,
                                 int itemCount) {
        }
        /**
         ...
         */
        public void onInitializeAccessibilityNodeInfo( Recycler recycler,
                                                       State state,  AccessibilityNodeInfoCompat info) {
         ...
         * {@link AccessibilityNodeInfoCompat.CollectionInfoCompat#SELECTION_MODE_NONE}.
         */
        public int getSelectionModeForAccessibility( Recycler recycler,
                                                     State state) {
        ...
        // called by accessibility delegate
        boolean performAccessibilityActionForItem( View view, int action,
                                                   Bundle args) {
         ...
         * @see View#performAccessibilityAction(int, Bundle)
         */
        public boolean performAccessibilityActionForItem( Recycler recycler,
    ...
    public abstract static class SmoothScroller {
         ...
         */
        protected abstract void onTargetFound( View targetView,  State state,
                                               Action action);
        /**
