...
import com.toolsfordevs.fast.modules.androidx.collection.LongSparseArray;
import com.toolsfordevs.fast.modules.androidx.core.util.Pools;

import static com.toolsfordevs.fast.modules.androidx.recyclerview.widget.ViewInfoStore.InfoRecord.*;
...
class ViewInfoStore {
    ...
    interface ProcessCallback {
        ...
        void processAppeared(RecyclerView.ViewHolder viewHolder, RecyclerView.ItemAnimator.ItemHolderInfo preInfo,
                             RecyclerView.ItemAnimator.ItemHolderInfo postInfo);
        void processPersistent(RecyclerView.ViewHolder viewHolder, RecyclerView.ItemAnimator.ItemHolderInfo preInfo,
                               RecyclerView.ItemAnimator.ItemHolderInfo postInfo);
