...
@Keep
internal class ColorResourcePicker(context: Context) : ResourcePickerView(context)
{
    ...
    init
    {
        ...
        val colorButton = addButton(
            R.drawable.fast_resourcepicker_ic_palette)
        ...
        viewDelegate = ColorViewDelegate(viewButton, recyclerView, Prefs::resourceColorPickerMode) { color -> listener?.invoke(color) }
        ...
        filterDelegate.updateResources(ResourceManager.colors)
    }
