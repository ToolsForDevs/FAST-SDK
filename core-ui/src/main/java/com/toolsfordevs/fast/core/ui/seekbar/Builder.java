...
public class Builder {
    ...
    Builder(Context context) {
        ...
        this.trackBackgroundSize = Dimens.dp(2);
        this.trackProgressSize = Dimens.dp(2);
        this.tickMarksSize = Dimens.dp(10);
        this.tickTextsSize = Dimens.sp(13);
        this.thumbSize = Dimens.dp(14);
    }
    ...
    public Builder trackBackgroundSize(int trackBackgroundSize) {
        this.trackBackgroundSize = Dimens.dp(trackBackgroundSize);
        return this;
    }
    ...
    public Builder trackProgressSize(int trackProgressSize) {
        this.trackProgressSize = Dimens.dp(trackProgressSize);
        return this;
    }
    ...
    public Builder thumbSize(int thumbSize) {
        this.thumbSize = Dimens.dp(thumbSize);
        return this;
    }
    ...
    public Builder tickTextsSize(int tickTextsSize) {
        this.tickTextsSize = Dimens.sp(tickTextsSize);
        return this;
    }
    ...
    public Builder tickMarksSize(int tickMarksSize) {
        this.tickMarksSize = Dimens.dp(tickMarksSize);
        return this;
    }
