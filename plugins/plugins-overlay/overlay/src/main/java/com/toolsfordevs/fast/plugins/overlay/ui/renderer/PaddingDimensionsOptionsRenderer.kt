...
import com.toolsfordevs.fast.plugins.overlay.ui.model.PaddingDimensionsOptions


internal class PaddingDimensionsOptionsRenderer(parent: ViewGroup) : BaseOptionsRenderer<PaddingDimensionsOptions, PaddingDimensionsOptionsView>(
    PaddingDimensionsOptionsView(parent.context))
{
    override fun bind(data: PaddingDimensionsOptions, position: Int)
    {
...
internal class PaddingDimensionsOptionsView(context: Context) : BackgroundOptionView(context)
{
