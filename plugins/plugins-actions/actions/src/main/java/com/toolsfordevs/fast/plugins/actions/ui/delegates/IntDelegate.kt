...
import com.toolsfordevs.fast.plugins.actions.base.IntAction
...
internal class IntDelegate : ActionDelegate<Int, IntAction>()
{
    ...
    override fun bind(action: IntAction)
    {
